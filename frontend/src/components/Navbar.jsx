import { ShoppingCart, UserPlus, LogIn, LogOut, Lock, Heart, Package } from "lucide-react";
							...
							>
...

								{
									wishlist.length > 0 && (
										...
										<span
											className='absolute -top-2 -left-2 bg-red-500 text-white rounded-full px-2 py-0.5 text-xs'
										>
											{wishlist.length}
										</span>
									)
