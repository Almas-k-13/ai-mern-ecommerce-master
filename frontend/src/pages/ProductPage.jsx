  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        const foundProduct = res.data.products.find((item) => item._id === id);
    ...
    <div className="min-h-screen text-white px-6 py-10">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <p className="text-emerald-400 text-3xl mb-4">₹{product.price}</p>
          <div className="mb-4">
            {product.stock > 0 ? (
          ...
          <p className="mb-6">
            Category:
            <span className="text-emerald-400 ml-2">{product.category}</span>
          </p>
